...
const Map = (props: { username: string }) => {
  ...
  useEffect(() => {
    ...
    mapNotesService
      .getNotesByLocation(locationName)
      .then((response) => {
    ...
    mapNotesService
      .getUserIdByUsername(props.username)
      .then((response) => {
  ...
  const onSubmit = (data: any) => {
    ...
    mapNotesService
      .postNotes(userId, locationName, data.notesText)
      .then(() => {
        mapNotesService
          .getNotesByLocation(locationName)
          .then((response) => {
          ...
          >
            <CardContent>
              ...
              >
                ...
                <Button onClick={handleCloseNote} color="error">
                  Cancel
                </Button>
              </form>
              <Snackbar
